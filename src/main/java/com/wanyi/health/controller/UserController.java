...
import com.wanyi.health.util.JacksonUtil;
...
public class UserController {
    ...
    @PostMapping("/level")
    public Object setLevel(@RequestParam Integer level, @RequestParam Integer userId) {
        return ResponseUtil.ok(userRepo.updateLevel(level, userId));
    }
